...
INSERT INTO appointment VALUES (6, 12, 8, 8, '2024-04-05 10:00:00', 'arranged');
INSERT INTO appointment VALUES (7, 15, 13, 7, '2024-04-12 14:45:00', 'arranged');
INSERT INTO appointment VALUES (8, 17, 15, 16, '2024-04-18 17:30:00', 'arranged');
INSERT INTO appointment VALUES (9, 19, 5, 9, '2024-04-22 11:45:00', 'arranged');
INSERT INTO appointment VALUES (10, 21, 9, 10, '2024-04-28 16:00:00', 'arranged');
...
INSERT INTO appointment VALUES (31, 5, 11, 3, '2024-04-02 09:30:00', 'arranged');
INSERT INTO appointment VALUES (32, 10, 7, 6, '2024-04-07 14:15:00', 'arranged');
INSERT INTO appointment VALUES (33, 14, 2, 3, '2024-04-12 16:45:00', 'arranged');
INSERT INTO appointment VALUES (34, 18, 12, 12, '2024-04-17 10:30:00', 'arranged');
INSERT INTO appointment VALUES (35, 22, 7, 16, '2024-04-22 13:45:00', 'arranged');
INSERT INTO appointment VALUES (36, 24, 14, 9, '2024-04-27 15:00:00', 'arranged');
INSERT INTO appointment VALUES (37, 1, 6, 2, '2024-04-03 09:30:00', 'arranged');
INSERT INTO appointment VALUES (38, 4, 8, 8, '2024-04-08 14:00:00', 'arranged');
INSERT INTO appointment VALUES (39, 12, 11, 3, '2024-04-13 16:15:00', 'arranged');
INSERT INTO appointment VALUES (40, 16, 13, 7, '2024-04-18 11:30:00', 'arranged');
...
INSERT INTO payment VALUES(5, (SELECT customer_id FROM appointment WHERE id = 5), '2024-03-28 13:15:00', (SELECT price FROM service WHERE id = 7), 'online');
INSERT INTO payment VALUES(6, (SELECT customer_id FROM appointment WHERE id = 6), '2024-04-05 10:00:00', (SELECT price FROM service WHERE id = 8), 'salon cash');
INSERT INTO payment VALUES(7, (SELECT customer_id FROM appointment WHERE id = 7), '2024-04-12 14:45:00', (SELECT price FROM service WHERE id = 13), 'salon cash');
INSERT INTO payment VALUES(8, (SELECT customer_id FROM appointment WHERE id = 8), '2024-04-18 17:30:00', (SELECT price FROM service WHERE id = 15), 'salon card');
INSERT INTO payment VALUES(9, (SELECT customer_id FROM appointment WHERE id = 9), '2024-04-22 11:45:00', (SELECT price FROM service WHERE id = 5), 'salon card');
INSERT INTO payment VALUES(10, (SELECT customer_id FROM appointment WHERE id = 10), '2024-04-28 16:00:00', (SELECT price FROM service WHERE id = 9), 'salon cash');
...
INSERT INTO payment VALUES(22, (SELECT customer_id FROM appointment WHERE id = 22), '2024-03-07 11:45:00', (SELECT price FROM service WHERE id = 15), 'online');
...
INSERT INTO payment VALUES(24, (SELECT customer_id FROM appointment WHERE id = 24), '2024-03-17 14:30:00', (SELECT price FROM service WHERE id = 14), 'online');
INSERT INTO payment VALUES(25, (SELECT customer_id FROM appointment WHERE id = 25), '2024-03-22 09:00:00', (SELECT price FROM service WHERE id = 5), 'online');
INSERT INTO payment VALUES(26, (SELECT customer_id FROM appointment WHERE id = 26), '2024-03-27 13:45:00', (SELECT price FROM service WHERE id = 1), 'online');
INSERT INTO payment VALUES(27, (SELECT customer_id FROM appointment WHERE id = 27), '2024-03-01 10:30:00', (SELECT price FROM service WHERE id = 8), 'online');
...
INSERT INTO payment VALUES(9, (SELECT customer_id FROM appointment WHERE id = 9), '2024-04-22 11:45:00', (SELECT price FROM service WHERE id = 5), 'salon card');
INSERT INTO payment VALUES(10, (SELECT customer_id FROM appointment WHERE id = 10), '2024-04-28 16:00:00', (SELECT price FROM service WHERE id = 9), 'salon cash');
INSERT INTO payment VALUES(31, (SELECT customer_id FROM appointment WHERE id = 31), '2024-04-02 09:30:00', (SELECT price FROM service WHERE id = 7), 'salon card');
INSERT INTO payment VALUES(32, (SELECT customer_id FROM appointment WHERE id = 32), '2024-04-07 14:15:00', (SELECT price FROM service WHERE id = 2), 'salon card');
INSERT INTO payment VALUES(33, (SELECT customer_id FROM appointment WHERE id = 33), '2024-04-12 16:45:00', (SELECT price FROM service WHERE id = 11), 'salon cash');
INSERT INTO payment VALUES(34, (SELECT customer_id FROM appointment WHERE id = 34), '2024-04-17 10:30:00', (SELECT price FROM service WHERE id = 13), 'salon cash');
INSERT INTO payment VALUES(35, (SELECT customer_id FROM appointment WHERE id = 35), '2024-04-22 13:45:00', (SELECT price FROM service WHERE id = 7), 'salon cash');
